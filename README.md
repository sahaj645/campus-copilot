...
Students rarely think in terms of which system to open. They think in terms of problems they want to solve.
...
```bash
git clone https://github.com/your-repository/campus-copilot.git
cd vit-ai-copilot
```
